...
class CommandInteraction extends Interaction {
    constructor(info, client) {
        ...
        this.channel = {
            id: info.channel_id,
            createMessage: (content, file) => this._client.createMessage.call(this._client, info.channel_id, content, file)
        };
        ...
        if(info.member) this.member = Object.assign({}, info.member, { premiumSince: new Date(info.member.premium_since), id: info.member.user.id, user: new User(info.member.user, this._client) })
