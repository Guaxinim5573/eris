...
class Message extends Base {
    constructor(data, client) {
        ...
        this.channel = {
            id: data.channel_id,
            createMessage: (content, file) => this._client.createMessage.call(this._client, data.channel_id, content, file)
        };
        this.content = "";
        this.hit = !!data.hit;
        this.reactions = {};
        ...
        if(data.member) this.member = Object.assign({}, data.member, { premiumSince: new Date(data.member.premium_since) })
